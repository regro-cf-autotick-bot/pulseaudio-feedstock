...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/pulseaudio-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pulseaudio-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pulseaudio pulseaudio-client pulseaudio-daemon
# for installing globally
pixi global install pulseaudio pulseaudio-client pulseaudio-daemon
```
...
It is possible to list all of the versions of `pulseaudio` available on your platform:
...
```
pixi search pulseaudio --channel conda-forge
```
